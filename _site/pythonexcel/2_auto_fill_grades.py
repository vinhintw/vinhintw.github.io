...
# os.mkdir("2_teachers_filled")

students = open("students.csv", mode="r", encoding="utf-8-sig")
students_10A1_math = open("2_teachers_filled/10A1_math.csv", mode="w", encoding="utf-8-sig", newline="")
students_10A2_math = open("2_teachers_filled/10A2_math.csv", mode="w", encoding="utf-8-sig", newline="")
students_10A3_math = open("2_teachers_filled/10A3_math.csv", mode="w", encoding="utf-8-sig", newline="")
students_10A1_literature = open("2_teachers_filled/10A1_literature.csv", mode="w", encoding="utf-8-sig", newline="")
students_10A2_literature = open("2_teachers_filled/10A2_literature.csv", mode="w", encoding="utf-8-sig", newline="")
students_10A3_literature = open("2_teachers_filled/10A3_literature.csv", mode="w", encoding="utf-8-sig", newline="")
